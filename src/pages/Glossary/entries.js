var entries = [
    {
        ...
        words: [
            ...
            {
                word: "action-based error detection",
            ...
            {
                word: "action slips",
                definition: "An error where the intent was correct but action did not occur as intended."
            },
            {
                word: "action step methods",
                definition: "Setting function discussed by Monden. It requires workers to perform a step that is not part of the operations on the product, like insuring the worker inserts their hand in the correct parts bin. See also motion-step method."
            },
            {
                word: "activation-trigger-schemata system",
                definition: "Actions which are commonly performed over time will become established as unconscious routines called schemas (or schemata, both are plural of schema). When the conscious mind intends to perform some action a group of relevant schemas are activated. Activated schema stand ready, waiting for specific triggers or cues from the environment in order to actually execute the schema. Errors result from unintentional activation of inappropriate schemas, loss of activation through interruption or forgotten intention, or faulty triggering of active schemas -- either false triggering by a similar cue, or failure to trigger. The more highly active a schema is, the easier it is to trigger it with similar cues Interruptions and interference by the conscious mind also play a major role in faulty triggering."
            },
            {
                word: "adjustment error",
                definition: "Number 8 of Nikkan Kogyo Shimbun (Factory Magazine) top 10 sources of defects"
            },
            {
                word: "alarms",
                definition: "One of Shingo's five basic classes of poka yoke devices. Used to cue workers to take action when an error or defect has occurred. See warning methods"
            },
            {
                word: "associative activation errors",
                definition: "A type of slip identified by Norman that is caused by an internal association of two activities. For example, calling children by their siblings' name."
            },
            {
                word: "ATS",
                definition: "See activation-trigger-schemata"
            },
            {
                word: "attribute control charts",
                definition: "A control chart used to plot data that is not based on actual numerical measurements. Attribute control charts include proportion defective (p) charts, number defective (np) charts, count of defects (c) charts, average number of defects (u) charts."
            },
            {
                word: "automation-induced complacency",
                definition: "The inattention that results from a human monitoring reliable automated equipment. As the perceived need for active intervention declines, the mind wanders. The ability to assess the state of the process and appropriately intervene is reduced."
            },
            {
                word: "autonomation",
                definition: "The automatic control of defects. It includes the practice of stopping machines when some deviation or variance is detected. The detection and stoppage can be effected by either a worker or a machine. Detection schemes include contact, altogether, and action step methods. Mistake-proofing as a quality control technique is a subset of autonomation. Autonomation can also be employed for other, non-quality, purposes."
            },
        ]
    },
    {
    ...
    },
    {
        ...
        words: [
            ...
            {
                word: "cognitive black box",
                definition: "A mechanism within the human mind that selects the appropriate rule or routine, or directs that conscious deliberative effort be applied. Relevant information about the problem or task, along with other environmental factors are inputs to a person's cognitive black box. The output is some action or decision."
            },
            {
                word: "cognitive control level",
                definition: "The selection of cognitive control method from the skill-, rule-, and knowledge-based cognitive control. Knowledge-based tasks involves a higher level of cognitive control than does skill-based."
            },
            {
                word: "cognitive demons",
                definition: "Term for schemata used by Reason and Mycielska. In part, this is due to the way they are summoned by the conscious mind to perform acts without its intervention. The primary reason, however, is because they are quite unruly, often activating without being summoned, wandering away to become inactive if not immediately triggered, being cued into action by the wrong trigger, or missing their cue, leaving action in the hands of another demon. It is this unruly nature which is the source of action slips. (Stewart)"
            },
            {
                word: "cognitive engineering",
                definition: "Rasmussen (1988) coined the term meaning designing products and processes using the error control strategies proposed by psychologists and systems designers."
            },
            {
                word: "complexity",
                definition: "No change from common usage. Complexity in assembly is measured by the difference between theoretical minimum operation times and projected actual operation times."
            },
            {
                word: "contact methods",
                definition: "\"Methods in which sensing devices detect abnormalities in product shape or dimension by whether or not contact is made\" (Shingo). These methods are usually used to check size, shape, orientation, presence/absence, or appearance. Also called physical poka-yokes."
            },
            {
                word: "control charts",
                definition: "The chief tool of SPC. A time series plot of process statistics used to monitor the stationarity of the process and detect when changes to the statistic appear to have occurred."
            },
            {
                word: "control limits",
                definition: "A statistical concept that indicates regions where a random variable's values are considered to be statistically unlikely (unusual) for a given process. Often these limits are 3 standard deviations above and below the mean. When an observation is further from the mean than the control limit, one infers that a special cause of variation exists and that remedial action to control the process is appropriate."
            },
            {
                word: "control methods",
                definition: "Devices are designed to stop production until any improper conditions are remedied."
            },
            {
                word: "counters",
                definition: "One of Shingo's five basic classes of poka yoke devices"
            ...
            {
                word: "counting poka-yokes",
                definition: "Mistake-proofing devices that monitor or check the number of repetitions of an action and warn or control the process when the correct number of actions have not been completed. Synonym for fixed-value methods"
            },
            {
                word: "cultural constraint",
                definition: "A mechanism for putting knowledge in the world by adhering to a known convention. The use of the color red to indicate caution or warning and the color green to indicate proper or acceptable status"
            },
        ]
    },
    {
    ...
    },
    {
        ...
        words: [
            {
                word: "nonconformity",
                definition: "Some aspect of a product that does not conform to its specifications"
            }
        ]
    },
    {
